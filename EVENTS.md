...
Generated 2026-09-01 · **55 events** · 164 weekly time slots · 12 EU / 43 NA
...
### Convergence CMs — [VII] (EU, Sat 12:00)
...
### Inner Nayos — Go Mango (NA, Daily 04:00)
...
| Convergence CMs | `[VII]` |  | Sat 12:00 | 2026-09-01 (0d) |
| Griffon Flight Training | `[Wing]` | Thy Weeping Willow.6851 | Mon 18:30 | 2026-09-01 (0d) |
| Convergence CMs | — |  | Mon 13:00 | 2026-09-01 (0d) |
...
| Core Meta Train | `[BUTR]` | Wolfspear.7180 | Daily 00:00 | 2026-09-01 (0d) |
| Convergence CMs | `[CC]` | SunMatrix.4168 | Tue 01:00 · Sat 18:00 | 2026-09-01 (0d) |
| Convergence CMs | `[COFE]` | SoBread.5628 | Wed, Fri 05:00 | 2026-09-01 (0d) |
...
| JW Convergence CMs | `[SAS]` | Mr Paul.8247 | Mon 20:00 | 2026-09-01 (0d) |
| SotO Convergence CMs | `[SAS]` | Mr Paul.8247 | Thu 20:00 | 2026-09-01 (0d) |
| HoT Meta Train | `[SHAZ]` | Shazilee.1098 | Wed, Sat, Sun 03:00 | **never** |
| Hero Point Train | `[SIN]` | Hempia.5981 | Sat 18:00 | **never** |
| Convergence CMs | `[SLPY]` |  | Sat 01:00 | 2026-09-01 (0d) |
| Silverwastes RIBA Farm | `[Sw]` | EverCursed.9084 | Daily 23:30 | 2026-09-01 (0d) |
| JW Convergence CMs | `[uLT]` | Ohnage.1638 | Sat 20:00 | 2026-09-01 (0d) |
| SotO Convergence CMs | `[uLT]` | Ohnage.1638 | Sun 17:00 | 2026-09-01 (0d) |
| Triple Trouble | `[WHAM]` | CasFamGaming.9843 | Daily 03:30 | 2026-08-31 (1d) |
| Convergence CMs | `[WILT]` | calmerthanu.8375 | Wed, Thu 01:00 | 2026-09-01 (0d) |
...
| SotO & JW Convergence CMs | `[ZERO]` | darens.2547 | Mon 14:00 | 2026-09-01 (0d) |
...
- `20:00` **JW Convergence CMs** `[SAS]` — Mr Paul.8247 (NA)
...
- `00:00` **Casino Blitz** `[MEAT]` — grace.3689 (NA)
- `00:00` **Core Meta Train** `[BUTR]` — Wolfspear.7180 (NA)
- `01:00` **Convergence CMs** `[CC]` — SunMatrix.4168 (NA)
...
- `00:00` **Casino Blitz** `[MEAT]` — grace.3689 (NA)
- `00:00` **Convergence CMs** `[LILY]` — LilyVelour.8395 (NA)
- `00:00` **Core Meta Train** `[BUTR]` — Wolfspear.7180 (NA)
...
- `00:00` **Casino Blitz** `[MEAT]` — grace.3689 (NA)
- `00:00` **Core Meta Train** `[BUTR]` — Wolfspear.7180 (NA)
- `01:00` **Convergence CMs** `[SLPY]` — null (NA)
- `01:30` **Gyala Delve** `[JMAW]` — Ruinandshotel.9278 (NA)
...
- `09:30` **EoD Meta Train** — Oregon.9387 (EU)
- `11:30` **EoD Meta Train** `[VEIN]` — Literious.4205 (EU)
- `12:00` **Convergence CMs** `[VII]` — null (EU)
- `12:00` **Triple Trouble** `[DCAP]` — Dark Raven.2160 (NA)
- `14:15` **Gyala Delve** `[VEIN]` — Literious.4205 (EU)
- `16:30` **Drizzlewood Coast** `[VEIN]` — Literious.4205 (EU)
- `18:00` **Convergence CMs** `[CC]` — SunMatrix.4168 (NA)
- `18:00` **Hero Point Train** `[SIN]` — Hempia.5981 (NA)
- `19:15` **Triple Trouble** — Tanylyla.6397 (EU)
- `19:30` **Triple Trouble** `[NOPE]` — Wolfspear.7180 (NA)
- `20:00` **JW Convergence CMs** `[uLT]` — Ohnage.1638 (NA)
- `21:00` **Convergence CMs** `[LILY]` — LilyVelour.8395 (NA)
- `23:20` **Bava Nisos Farm & Meta** — Sylphonete.7583 (NA)
- `23:30` **Silverwastes RIBA Farm** `[Sw]` — EverCursed.9084 (NA)
